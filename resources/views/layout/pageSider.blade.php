              ...
              <div id="sidebar-menu">
                <ul class="sidebar-links" id="simple-bar">
                  ...
                  <li class="sidebar-list">
                   ...
                   <li><a href="{{route('userPro.create')}}"><i data-feather="home"></i>User's Details</a></li><br>
                  <!-- <li><a href="{{ url('userProject') }}"><i data-feather="home"></i> User's payment Details</a></li><br> -->
                   <li><a href="{{ route('userPro.profile') }}"><i data-feather="home"></i>Customer's Profile</a></li><br>
                    <li><a href="{{route('exercise.create')}}"><i data-feather="home"></i>Add Exercise</a></li><br>
                   <li><a href="{{ route('exercise.index') }}"><i data-feather="home"></i>Exercise Details</a></li><br>
                   <li><a href="payment-details.php"><i data-feather="home"></i>Payment</a></li><br>
                  <li><a href="kanban.php"><i data-feather="home"></i>Payment Histroy</a></li><br>
                  <li><a href="product.php"><i data-feather="home"></i>Exercise Details</a></li><br>
                 
                  <br><br><br>
                  <li class="sidebar-list"><a class="sidebar-link sidebar-title" href="#"><i data-feather="airplay"></i><span class="lan-6">Widgets</span></a>
                    <ul class="sidebarproduct.php">
                  ...
                  <li class="sidebar-list"><a class="sidebar-link sidebar-title link-nav" href="http://admin.pixelstrap.com/cuba/starter-kit/index.html" target="_blank"><i data-feather="anchor"></i><span>Starter kit</span></a></li>
