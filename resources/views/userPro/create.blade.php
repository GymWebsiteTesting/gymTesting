...
<br><br>
                        ...
                        <div class="col-sm-6 col-md-6">
                          <div class="mb-3">
                            ...
                            <input class="form-control" type="email" name="email" placeholder="aa@gmail.com">
                          </div>
                        </div>
                        </div>
                        <div class="col-md-12">
                        ...
                        <div class="col-sm-6 col-md-4">
                          <div class="mb-3">
                            ...
                            <input class="form-control" type="text" name="contact_number" placeholder="011223765">
                          </div>
                          </div>
                        </div>
                        ...
                        <div class="col-md-5">
                          <div class="mb-3">
                            ...
                            <label class="form-label">User Type</label>
                             <select class="form-control btn-square" name="user_type">
                         ...
                         <div class="col-sm-6 col-md-6">
                          <div class="mb-3">
                            ...
                            <label>Body Height</label>
                              <input class="form-control" type="text" name="body_height" placeholder="165 cm">
                            </div>
                          </div>
                        </div>
                        <div class="col-sm-6 col-md-6">
                          <div class="mb-3">
                           ...
                           <input class="form-control" type="text" name="body_weight" placeholder="80Kg">
                          </div>
                        </div>
                        </div>
                        <div class="col-md-12">
