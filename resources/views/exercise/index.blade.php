                  ...
                  <div class="col-xl-3 col-sm-6 xl-4">
                    <div class="card">
                      <div class="product-box">
                        <div class="product-img"><img class="img-fluid" src="{{ URL::to($exe->EPhoto) }}" alt="">
                            ...
                            <div class="modal-content">
                              <div class="modal-header">
                                <div class="product-box row">
                                  <div class="product-img col-lg-6"><img class="img-fluid" src="{{ URL::to($exe->EPhoto) }}" alt=""></div>
                        ...
                        <!--   <div class="rating"><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i></div> -->
                          <h4>Exercise Name: {{ $exe->exercise_name }}</h4>
                          <p>Exercise Details: {{ $exe->exercise_details}}</p>
                          <div class="product-price">
                          Exercise Type: {{ $exe->exercise_type}} 
                            <!-- <del>$350.00    </del> -->
                          </div>
                        </div>
                      </div>
